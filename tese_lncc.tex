%% abtex2-modelo-tese-lncc.tex, v-1.0
%%
%% The latest version of this model is in
%%   ????
%%
%% Created by:
%% Weslley S. Pereira
...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   \assinatura{\textbf{Prof. Lucas, M.Sc.} \\ Membro da banca 1}
   \assinatura{\textbf{Prof. César, Ph.D.} \\ Membro da banca 2}
   \assinatura{\textbf{Prof. Júlio} \\ Membro da banca 3}
   %\assinatura{\textbf{Avaliador 4} \\ Membro da banca 4}
